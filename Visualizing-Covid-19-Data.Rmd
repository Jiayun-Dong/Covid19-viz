...
Now we move onto US data. Currently, there are about `r paste0(round(dat %>% filter(date == max(date)) %>% summarise(total_cases = sum(positive)) %>% pull()/1000),",000")` confirmed cases of Covid-19 in the US. 
